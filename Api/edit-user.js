...
editUser.addEventListener('submit', function (e) { return __awaiter(_this, void 0, void 0, function () {
    var payload, options;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, fetch("https://todo-app-fae2a-default-rtdb.firebaseio.com/users/".concat(user, ".json"), options)];
            case 1:
                _a.sent();
